export const astroPortfolioContent = {
    ...
    id: {
        ...
        pitch: "Situs ini sendiri merupakan sebuah portofolio pribadi dwibahasa (Indonesia/Inggris) yang dirancang dan dibangun dari awal menggunakan Astro dan CSS murni tanpa menggunakan *UI framework* atau pustaka komponen pihak ketiga. Setiap proyek yang ditampilkan dikemas dengan sorotan teknis yang komprehensif, dilengkapi dengan penjelasan *pitch* mendalam, fitur utama, rincian tumpukan teknologi, narasi arsitektur rekayasa tertulis, serta daftar keterbatasan yang diketahui secara transparan. Selain itu, halaman `/stats` secara otomatis menghitung frekuensi penggunaan setiap teknologi di seluruh proyek dan menyediakan *tag cloud* interaktif yang memungkinkan pengunjung menjelajahi proyek terkait hanya dengan satu klik.",
        ...
        featureGroups: [
            ...
            },
            {
                ...
                items: [
                    ...
                    "Halaman sorotan teknis terperinci untuk setiap proyek — mencakup deskripsi utama, pengelompokan fitur terstruktur, tumpukan teknologi, narasi rekayasa teknis, serta catatan keterbatasan.",
                ],
            },
            {
        ...
        stackGroups: [
            ...
            },
            {
                ...
                items: [
                    "CSS kustom dengan sistem *design token* berbasis *custom property* — dibangun tanpa TailwindCSS atau pustaka komponen eksternal.",
        ...
        studyTitle: "Sorotan Teknis: Resolusi Build Statis vs. Pemuatan Ikon saat Runtime",
        story: [
            {
            ...
            },
            {
                ...
                body: "Untuk memverifikasi akar masalah, halaman statistik yang baru dibuat dihapus sementara dan proses *build* dijalankan ulang. Halaman rincian teknis lama yang sebelumnya berjalan normal ternyata mengalami kegagalan dengan *error* yang identik. Hal ini membuktikan bahwa *bug* tersebut bukan disebabkan oleh kode fitur statistik baru, melainkan oleh asumsi *path* relatif pada `Icon` dan `TechIcon` yang tidak valid saat berjalan di dalam hasil *bundle* kompilasi produksi.",
            },
            {
