export const icareLandslideContent = {
    ...
    id: {
        ...
        featureGroups: [
            ...
            },
            {
                ...
                items: [
                    ...
                    "Panel telaah esai (*drawer*) mendalam yang menampilkan jawaban asli siswa, rincian sub-skor tiap pertanyaan, dan umpan balik analitis dari AI untuk transparansi penilaian yang dapat ditinjau ulang oleh guru.",
                ],
            },
            {
        ...
        studyTitle: "Sorotan Teknis: Membangun Ulang Kursus Storyline 360 Tanpa Berkas Sumber",
        story: [
            {
